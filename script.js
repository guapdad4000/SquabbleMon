...
const battleBackgrounds = [
  "https://i.imgur.com/ZvMKSyp.jpg", // Urban city background
  "https://i.imgur.com/QNsJH3D.jpg", // Alleyway background
  "https://i.imgur.com/GdNpKUK.jpg", // Street scene background
  "https://i.imgur.com/nY7oky9.jpg", // Urban night background
  "https://i.imgur.com/Zg7XCl1.jpg", // Additional city background
  "https://i.imgur.com/XO2cC9N.jpg"  // Additional urban background
];
...
function updateBattleUI() {
  ...
  const existingPlayerContainer = document.querySelector(".player-sprite-container");
  if (existingPlayerContainer) {
    console.log("Removing existing player sprite container");
    existingPlayerContainer.remove();
  }
  
  const existingOpponentContainer = document.querySelector(".opponent-sprite-container");
    ...
    try {
      ...
      if (!playerSpriteElem) {
        ...
        if (!playerContainer) {
          ...
          // Create container
          const container = document.getElementById("battle-background") || document.body;
