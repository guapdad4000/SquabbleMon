...
const characters = [
    ...
    moves: [
      {
        ...
        accuracy: 90,
        type: "Electric",
        description: "Electric shock that may cause paralysis.",
        pp: 15,
        maxPp: 15,
      },
      {
      ...
      },
      {
        ...
        accuracy: 100,
        type: "Electric",
        description: "Raises speed with venture capital backing.",
        pp: 10,
        maxPp: 10,
      },
      {
        ...
        accuracy: 80,
        type: "Dark",
        description: "Financial attack that can cause confusion.",
        pp: 10,
        maxPp: 10,
      },
    ],
    ...
    moves: [
      {
        ...
        accuracy: 95,
        type: "Dark",
        description: "Deceptive attack with good accuracy.",
        pp: 15,
        maxPp: 15,
      },
      {
        ...
        accuracy: 80,
        type: "Electric",
        description: "Financial attack that may cause paralysis.",
        pp: 10,
        maxPp: 10,
      },
      {
        ...
        accuracy: 100,
        type: "Dark",
        description: "Raises speed through deception.",
        pp: 10,
        maxPp: 10,
      },
      {
        ...
        accuracy: 85,
        type: "Dark",
        description: "Steals opponent's identity for extra damage.",
        pp: 10,
        maxPp: 10,
      },
    ],
  },
  {
    ...
    status: "normal",
    description:
      "Permanently hazy. Might forget what move it was using mid-battle.",
    moves: [
      {
        name: "Cloud Cough",
        power: 40,
        accuracy: 100,
        type: "Air",
        description: "Smoky attack that may lower accuracy.",
        pp: 15,
        maxPp: 15,
      },
      {
        ...
        accuracy: 95,
        type: "Fire",
        description: "Hazy attack that may cause sleep.",
        pp: 15,
        maxPp: 15,
      },
      {
        ...
        accuracy: 100,
        type: "Normal",
        description: "Uses smoke to raise defense.",
        pp: 10,
        maxPp: 10,
      },
      {
        name: "Dazed Confusion",
        power: 60,
        accuracy: 85,
        type: "Dark",
        description: "Confused attack that may cause confusion to both sides.",
        pp: 10,
        maxPp: 10,
      },
    ],
  },
  {
    ...
    status: "normal",
    description:
      "Just grilled. Enjoys well-maintained lawns and quiet evenings.",
    moves: [
      {
        name: "Lawnmower Lash",
        power: 50,
        accuracy: 95,
        type: "Plant",
        description: "Plant attack using lawn care tools.",
        pp: 15,
        maxPp: 15,
      },
      {
        ...
        accuracy: 85,
        type: "Fire",
        description: "Grilling attack that may cause burn.",
        pp: 10,
        maxPp: 10,
      },
      {
        ...
        accuracy: 100,
        type: "Normal",
        description: "Uses suburban defenses to boost defense.",
        pp: 10,
        maxPp: 10,
      },
      {
        ...
        accuracy: 100,
        type: "Normal",
        description: "Bureaucratic attack with perfect accuracy.",
        pp: 15,
        maxPp: 15,
      },
    ],
    ...
    moves: [
      {
        ...
        accuracy: 95,
        type: "Normal",
        description: "Trick attack with good accuracy.",
        pp: 15,
        maxPp: 15,
      },
      {
        ...
        accuracy: 90,
        type: "Fire",
        description: "Bike exhaust attack that may cause burn.",
        pp: 10,
        maxPp: 10,
      },
      {
        ...
        accuracy: 100,
        type: "Electric",
        description: "Uses bike momentum to boost speed.",
        pp: 10,
        maxPp: 10,
      },
      {
        ...
        accuracy: 100,
        type: "Normal",
        description: "Impressive trick that lowers opponent's attack.",
        pp: 10,
        maxPp: 10,
      },
    ],
    ...
    moves: [
      {
        ...
        accuracy: 85,
        type: "Normal",
        description: "Quick moves that may lower opponent's speed.",
        pp: 15,
        maxPp: 15,
      },
      {
        ...
        accuracy: 75,
        type: "Fire",
        description: "High-risk, high-reward scoring move.",
        pp: 10,
        maxPp: 10,
      },
      {
        ...
        accuracy: 85,
        type: "Normal",
        description: "Aggressive dunk that may cause flinching.",
        pp: 10,
        maxPp: 10,
      },
      {
        ...
        accuracy: 100,
        type: "Normal",
        description: "Uses support to heal HP.",
        pp: 5,
        maxPp: 5,
      },
    ],
  },
  {
    ...
    status: "normal",
    description:
      "'Yo, chat! Smash that like button!' Always online, never AFK.",
    moves: [
      {
        name: "Stan Submission",
        power: 40,
        accuracy: 100,
        type: "Normal",
        description: "Fan-powered attack with perfect accuracy.",
        pp: 20,
        maxPp: 20,
      },
      {
        ...
        accuracy: 100,
        type: "Normal",
        description: "Uses online clout to boost speed.",
        pp: 10,
        maxPp: 10,
      },
      {
        ...
        accuracy: 90,
        type: "Dark",
        description: "Monetization attack that lowers defense.",
        pp: 10,
        maxPp: 10,
      },
      {
        ...
        accuracy: 85,
        type: "Electric",
        description: "Annoying notification attack with flinch chance.",
        pp: 15,
        maxPp: 15,
      },
    ],
...
let opponents = [
    ...
    moves: [
      {
        ...
        accuracy: 90,
        type: "Electric",
        description: "Electric-type attack that may cause paralysis.",
        pp: 15,
        maxPp: 15,
      },
      {
        ...
        accuracy: 70,
        type: "Normal",
        description: "Normal-type powerful attack with low accuracy.",
        pp: 5,
        maxPp: 5,
      },
      {
        ...
        accuracy: 100,
        type: "Electric",
        description: "Raises speed with venture capital energy.",
        pp: 10,
        maxPp: 10,
      },
      {
        ...
        accuracy: 80,
        type: "Dark",
        description: "Dark-type attack with medium power and accuracy.",
        pp: 10,
        maxPp: 10,
      },
    ],
  ...
  },
  {
    ...
    type: "Poison",
    description:
      "Moves fast, thinks faster... maybe too fast. Always looking for the next score.",
    moves: [
      {
        name: "Scrap Scramble",
        power: 40,
...
function initMobileControls() {
  ...
  if (isMobile) {
    ...
    if (isInBattle) {
      ...
      if (mobileContainer) {
        ...
        console.log(
          "Mobile device detected, showing controls:",
          mobileContainer,
        );
  ...
  window.addEventListener("message", function (event) {
    ...
    if (keyData.type === "keypress") {
      ...
      const isInOverworld =
        overworldContainer && overworldContainer.style.display !== "none";
      ...
      if (isInOverworld) {
        ...
        if (window.NewOverworldSystem) {
          ...
          typeof window.OverworldSystem.handleKeyPress === "function"
        ) {
          ...
          console.log(
            "No compatible overworld system found, using regular message forwarding",
          );
    ...
    switch (currentScreen) {
      case "selection":
        ...
        return startButton && !startButton.disabled
          ? [...characters, startButton]
          : characters;
      case "battle":
        // Get both moves and items for a unified navigation
        const moveButtons = Array.from(
          document.querySelectorAll("#moves button:not(:disabled)"),
        );
        const itemButtons = Array.from(
          document.querySelectorAll("#items button:not(:disabled)"),
        );
      ...
      case "switch":
        return Array.from(
          document.querySelectorAll(
            ".switch-option:not(.fainted):not(.current)",
          ),
        );
      case "simple-switch":
        return Array.from(
          document.querySelectorAll("#simple-switch-prompt button"),
        );
      case "game-over":
        return Array.from(
          document.querySelectorAll(
            "#game-over button:not([style*='display: none'])",
          ),
        );
      default:
        return [];
  ...
  function initNav() {
    ...
    if (navItems.length > 0) {
      ...
      console.log(
        "Focus set to:",
        navItems[navIndex].textContent || "unnamed element",
      );
    } else {
      navIndex = -1;
      currentFocus = null;
  ...
  function handleDpadUp() {
    ...
    if (currentScreen === "selection") {
      ...
      const cardsPerRow = Math.floor(
        document.getElementById("character-list").clientWidth /
          navItems[0].clientWidth,
      );
  ...
  function handleBButton() {
    ...
    switch (currentScreen) {
      ...
      case "simple-switch":
        ...
        const noBtn = document.querySelectorAll(
          "#simple-switch-prompt button",
        )[1];
        if (noBtn) {
          noBtn.click();
        }
    ...
    try {
      ...
      if (playerTeam[0]) {
        ...
        if (!playerTeam[0].sprite) {
          ...
          console.log(
            "Setting sprite from character image:",
            playerTeam[0].sprite,
          );
        }
      }
      ...
      // Fall back to the original overworld system if needed
        ...
        console.error(
          "No overworld system found or initialization function missing",
        );
  ...
  function continueReturnToOverworld() {
    try {
      ...
      if (typeof window.NewOverworldSystem?.returnToOverworld === "function") {
        console.log(
          "Calling new overworld system's returnToOverworld function",
        );
        ...
        console.error(
          "New overworld system not found or return function missing",
        );
...
console.log(
  "Exposing essential functions to window object:",
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (window.activeOpponent) {
    console.log(
      "Clearing previously set active opponent:",
      window.activeOpponent.name,
    );
  ...
  console.log(
    "Game functions exposed to window object:",
...
function useFirstMove() {
  ...
  if (
    ...
    playerCharacter.moves.length > 0
  ) {
    // Get the first move
  ...
  cornerStore: {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Revive Kit",
        price: 30,
        description: "Revives a fainted character",
        effect: { type: "revive", value: 30 },
      },
      {
        id: "energy_drink",
        name: "Energy Drink",
        ...
        effect: { type: "statBoost", stat: "speed", value: 1.5, duration: 3 },
      },
    ],
  },
  trapShop: {
    ...
    items: [
      {
        ...
        name: "Smoke Bomb",
        price: 15,
        description: "Lowers opponent accuracy",
        effect: { type: "debuff", stat: "accuracy", value: 0.7, duration: 3 },
      },
      {
        id: "brass_knuckles",
        name: "Brass Knuckles",
        ...
        effect: { type: "statBoost", stat: "attack", value: 1.4, duration: 3 },
      },
      {
        id: "kevlar",
        name: "Kevlar Vest",
        ...
        effect: { type: "statBoost", stat: "defense", value: 1.5, duration: 3 },
      },
    ],
  },
};
...
function initGame() {
  ...
  // Initialize shops
  gameShops = {
    cornerStore: window.ShopSystem.createShopInventory(
      window.ShopSystem.SHOP_TYPES.CORNER_STORE,
    ),
    theTrap: window.ShopSystem.createShopInventory(
      window.ShopSystem.SHOP_TYPES.THE_TRAP,
    ),
    cloutDealer: window.ShopSystem.createShopInventory(
      window.ShopSystem.SHOP_TYPES.CLOUT_DEALER,
    ),
    popUpVan: window.ShopSystem.createShopInventory(
      window.ShopSystem.SHOP_TYPES.POP_UP_VAN,
    ),
  };
...
function standardizeSpritePath(spritePath) {
  ...
  if (
    ...
    typeof window.FixedSpriteManager.standardizeSpritePath === "function"
  ) {
    try {
  ...
  try {
    ...
    if (spriteMap[fileName]) {
      logSprite(
        `Mapped filename ${fileName} to direct URL`,
        spriteMap[fileName],
      );
    ...
    if (spritePath.includes("imgur.com")) {
      ...
      if (
        spritePath.includes("imgur.com") &&
        !spritePath.includes("i.imgur.com")
      ) {
        try {
  ...
  if (lowercasePath.includes("fitness") || lowercasePath.includes("gym")) {
    ...
    lowercasePath.includes("rasta") ||
    lowercasePath.includes("plant")
  ) {
    return "https://i.imgur.com/OH3B6YT.png"; // Updated Rasta Mon URL
  } else if (
    lowercasePath.includes("tech") ||
    lowercasePath.includes("electric")
  ) {
    ...
    lowercasePath.includes("9-5") ||
    lowercasePath.includes("office")
  ) {
    return "https://i.imgur.com/UkE9crR.png"; // 9-5
  } else if (
    lowercasePath.includes("jokes") ||
    lowercasePath.includes("all jokes")
  ) {
    return "https://i.imgur.com/9hFTFQt.png"; // All jokes
  } else if (
    lowercasePath.includes("nerd") ||
    lowercasePath.includes("closet")
  ) {
    return "https://i.imgur.com/knA2Yxz.png"; // Closet nerd
  } else if (
    lowercasePath.includes("functional") ||
    lowercasePath.includes("addict")
  ) {
    ...
    lowercasePath.includes("rich") ||
    lowercasePath.includes("techbro")
  ) {
  ...
  if (
    lowercasePath.includes("back") ||
    lowercasePath.includes("fwd") ||
    lowercasePath.includes("right") ||
    lowercasePath.includes("left")
  ) {
    // Map to direct imgur URLs
    if (lowercasePath.includes("back")) {
      return lowercasePath.includes("2")
        ? "https://i.imgur.com/zyQYr6k.png"
        : "https://i.imgur.com/1rSNlYO.png";
    } else if (lowercasePath.includes("fwd")) {
      return lowercasePath.includes("2")
        ? "https://i.imgur.com/aXt732G.png"
        : "https://i.imgur.com/qxnS0SH.png";
    } else if (lowercasePath.includes("left")) {
      return lowercasePath.includes("2")
        ? "https://i.imgur.com/oW9gHVE.png"
        : "https://i.imgur.com/LlMLcyZ.png";
    } else if (lowercasePath.includes("right")) {
      return lowercasePath.includes("2")
        ? "https://i.imgur.com/0uheBxU.png"
        : "https://i.imgur.com/7D40jZG.png";
    }
  }
...
window.debugSpritePaths = function (playerTeam, opponentTeam) {
  ...
  if (opponentTeam && Array.isArray(opponentTeam)) {
    ...
    console.log(
      `  ${window.activeOpponent.name}: ${window.activeOpponent.sprite || "undefined"}`,
    );
    if (window.activeOpponent.sprite) {
      const standardizedPath = standardizeSpritePath(
        window.activeOpponent.sprite,
      );
...
function selectCharacter(character) {
  ...
  if (playerTeam.some((c) => c.id === characterCopy.id)) {
    ...
    document
      .querySelector(`.character-card[data-id="${characterCopy.id}"]`)
...
function updateTeamSlots() {
  ...
  playerTeam.forEach((character, index) => {
    if (index < slots.length) {
      console.log(
        `Setting slot ${index} with ${character.name}, sprite: ${character.sprite}`,
      );
      ...
      img.onload = function () {
        console.log(
          `Team slot ${index} sprite loaded successfully: ${spritePath}`,
        );
      };
...
function startBattle() {
  ...
  if (
    ...
    console.log(
      "Found window.playerTeam, syncing with local playerTeam:",
      window.playerTeam,
    );
    ...
    playerTeam.forEach((character) => {
      if (character.sprite) {
        ...
        console.log(
          `Standardized player sprite: ${character.name} → ${character.sprite}`,
        );
      }
    });
  ...
  if (window.activeOpponent) {
    ...
    if (opponents[0].sprite) {
      ...
      console.log(
        `Standardized opponent sprite: ${opponents[0].name}`,
        originalOpponentSprite,
        "→",
        opponents[0].sprite,
      );
      ...
      if (
        ...
        window.SpriteManager.debugSpriteIssues(
          "START_BATTLE_OPPONENT",
          opponents[0],
        );
      }
    }
    ...
    if (window.activeOpponent && window.activeOpponent.sprite) {
      window.activeOpponent.sprite = standardizeSpritePath(
        window.activeOpponent.sprite,
      );
    }
  }
  ...
  if (currentGameMode !== "story" && playerTeam.length !== 3) {
    console.error(
      "Player team not properly initialized, needs exactly 3 characters in Fade Mode",
    );
  ...
  // Schedule sprite visibility fix call after UI becomes visible
  setTimeout(() => {
    // This will run after the DOM has had time to render the battle screen
    if (typeof ensureBattleSpritesVisible === "function") {
      ...
      if (playerSprite && activePlayerCharacter) {
        ...
        if (activePlayerCharacter.name === "Fitness Bro") {
          ...
          playerSprite.src = standardizeSpritePath(
            activePlayerCharacter.sprite,
          );
        }
    ...
    window.debugSpritePaths = function (playerTeam, opponentTeam) {
      ...
      if (Array.isArray(playerTeam)) {
        playerTeam.forEach((char, index) => {
          console.log(
            `Player ${index} (${char.name || "unnamed"}): ${char.sprite || "NO SPRITE"}`,
          );
        });
      } else {
      ...
      if (Array.isArray(opponentTeam)) {
        opponentTeam.forEach((char, index) => {
          console.log(
            `Opponent ${index} (${char.name || "unnamed"}): ${char.sprite || "NO SPRITE"}`,
          );
        });
      } else {
  ...
  if (activePlayerCharacter.name === "Fitness Bro") {
    console.log(
      "⚠️ Ensuring Fitness Bro sprite is explicitly set on activePlayerCharacter",
    );
      ...
      opponents = [
        {
          ...
          moves: [
            ...
            },
            {
              ...
              power: 0,
              type: "status",
              statusEffect: { type: "defense-up", duration: 3 },
            },
          ],
        },
      ];
  ...
  if (window.currentGameMode === "story") {
    ...
    console.log(
      "Fade mode battle started, processing first turn automatically",
    );
    setTimeout(() => {
      processTurn();
    }, 1000);
...
function updateBattleUI() {
  ...
  // First ensure the battle-arena exists and has all necessary elements
  const battleArena = document.querySelector("#battle-arena");
  const battleScreen = document.getElementById("battle-screen");

  if (!battleArena) {
    console.log("Battle arena not found, creating battle-screen structure");

    // Create new battle arena
    const newBattleArena = document.createElement("div");
    ...
    playerArea.innerHTML = `
      <p id="player-name" class="yn-name">${activePlayerCharacter ? activePlayerCharacter.name : "Player"}</p>
      <div class="hp-bar">
        <div class="hp-fill" id="player-hp-fill"></div>
        <span id="player-status-icon" class="status-icon"></span>
      </div>
      <p id="player-hp" class="yn-hp-value">${activePlayerCharacter ? activePlayerCharacter.hp : "100"}</p>
    `;
    newBattleArena.appendChild(playerArea);

    // Create opponent area with all necessary elements
    const opponentArea = document.createElement("div");
    opponentArea.id = "opponent-area";
    opponentArea.innerHTML = `
      <p id="opponent-name" class="yn-name">${activeOpponent ? activeOpponent.name : "Opponent"}</p>
      <div class="hp-bar">
        <div class="hp-fill" id="opponent-hp-fill"></div>
        <span id="opponent-status-icon" class="status-icon"></span>
      </div>
      <p id="opponent-hp" class="yn-hp-value">${activeOpponent ? activeOpponent.hp : "100"}</p>
    `;
    newBattleArena.appendChild(opponentArea);
  }

  // Remove existing sprite containers if they exist
  const existingPlayerContainer = document.querySelector(
  ...
  const existingOpponentContainer = document.querySelector(
  ...
  // Create sprite containers and sprites
  ...
  playerSpriteContainer.style.bottom = "25%";
  playerSpriteContainer.style.left = "10%";
  playerSpriteContainer.style.zIndex = "100";
  document.getElementById("player-area").appendChild(playerSpriteContainer);
  ...
  playerSprite.alt = "";
  playerSprite.style.maxHeight = "170px";
  playerSprite.style.maxWidth = "170px";
  ...
  opponentSpriteContainer.style.top = "10%";
  opponentSpriteContainer.style.right = "10%";
  opponentSpriteContainer.style.zIndex = "100";
  document.getElementById("opponent-area").appendChild(opponentSpriteContainer);
  ...
  opponentSprite.alt = "";
  opponentSprite.style.maxHeight = "170px";
  opponentSprite.style.maxWidth = "170px";
  opponentSpriteContainer.appendChild(opponentSprite);

  // SPRITE SOURCES
  // Set player sprite source
  if (activePlayerCharacter) {
    console.log("Setting player sprite source:", activePlayerCharacter.name);

    // Special handling for Fitness Bro
    if (activePlayerCharacter.name === "Fitness Bro") {
      console.log("Setting Fitness Bro sprite source");
      playerSprite.src = "https://i.imgur.com/qxnS0SH.png";
    } else {
  ...
  // Set opponent sprite source
  if (activeOpponent) {
    console.log("Setting opponent sprite source:", activeOpponent.name);
    opponentSprite.src = standardizeSpritePath(activeOpponent.sprite);
    ...
    opponentSprite.onload = function () {
      console.log("Opponent sprite loaded successfully");
      opponentSprite.style.display = "block";
      opponentSprite.style.visibility = "visible";
    };
  }
  ...
  if (playerNameElement) {
    console.log(
      "Player name element before setting:",
      playerNameElement.innerHTML,
    );
    playerNameElement.textContent = activePlayerCharacter.name;
    console.log(
      "Player name element after setting:",
      playerNameElement.innerHTML,
    );
  }

  // Make sure maxHp is set for both active characters
  activePlayerCharacter.maxHp =
    activePlayerCharacter.maxHp || activePlayerCharacter.hp;
  activeOpponent.maxHp = activeOpponent.maxHp || activeOpponent.hp;
  ...
  // Create a robust function to handle sprite loading/displaying
  function ensureBattleSpritesVisible() {
    console.group("🎯 ENSURING BATTLE SPRITES ARE VISIBLE");

    try {
      // Fix player sprite
      const playerSpritePath = standardizeSpritePath(
        activePlayerCharacter.sprite,
      );
      console.log("Player sprite path:", playerSpritePath);

      // Ensure we have a player sprite element
      let playerSpriteElem = document.getElementById("player-sprite");
      if (!playerSpriteElem) {
        console.warn("Player sprite element missing, creating it");
        const playerContainer = document.getElementById(
          "player-sprite-container",
        );

        if (!playerContainer) {
          console.warn("Player container missing too, creating both");
          // Create container
          const container =
            document.getElementById("battle-background") || document.body;
          const newContainer = document.createElement("div");
          newContainer.id = "player-sprite-container";
          newContainer.style.position = "absolute";
          newContainer.style.left = "10%";
          newContainer.style.bottom = "20%";
          newContainer.style.width = "240px";
          newContainer.style.height = "240px";
          newContainer.style.zIndex = "50";
          container.appendChild(newContainer);

          // Create sprite
          playerSpriteElem = document.createElement("img");
          playerSpriteElem.id = "player-sprite";
          playerSpriteElem.alt = "Player";
          newContainer.appendChild(playerSpriteElem);
        } else {
          // Just create sprite
          playerSpriteElem = document.createElement("img");
          playerSpriteElem.id = "player-sprite";
          playerSpriteElem.alt = "Player";
          playerContainer.appendChild(playerSpriteElem);
        }
      }
      ...
      playerSpriteElem.onerror = function () {
        ...
        playerSpriteElem.src = "https://i.imgur.com/YeMI4sr.png"; // Fitness Bro fallback
      };

      // Fix opponent sprite
      const opponentSpritePath = standardizeSpritePath(activeOpponent.sprite);
      console.log("Opponent sprite path:", opponentSpritePath);

      // Ensure we have an opponent sprite element
      let opponentSpriteElem = document.getElementById("opponent-sprite");
      if (!opponentSpriteElem) {
        console.warn("Opponent sprite element missing, creating it");
        const opponentContainer = document.getElementById(
          "opponent-sprite-container",
        );

        if (!opponentContainer) {
          console.warn("Opponent container missing too, creating both");
          // Create container
          const container =
            document.getElementById("battle-background") || document.body;
          const newContainer = document.createElement("div");
          newContainer.id = "opponent-sprite-container";
          newContainer.style.position = "absolute";
          newContainer.style.right = "10%";
          newContainer.style.top = "20%";
          ...
          // Create sprite
          opponentSpriteElem = document.createElement("img");
          opponentSpriteElem.id = "opponent-sprite";
          opponentSpriteElem.alt = "Opponent";
          newContainer.appendChild(opponentSpriteElem);
        } else {
          // Just create sprite
          opponentSpriteElem = document.createElement("img");
          opponentSpriteElem.id = "opponent-sprite";
          opponentSpriteElem.alt = "Opponent";
          opponentContainer.appendChild(opponentSpriteElem);
        }
      }

      // Set opponent sprite attributes
      ...
      opponentSpriteElem.style.position = "relative";
      ...
      opponentSpriteElem.onerror = function () {
        console.error("Opponent sprite failed to load, using fallback");
        opponentSpriteElem.src = "https://i.imgur.com/UkE9crR.png"; // 9-5 Homie fallback
      };
      ...
      setTimeout(() => {
        ...
        // Ensure opponent sprite is visible
        if (opponentSpriteElem) {
          opponentSpriteElem.style.display = "block";
          opponentSpriteElem.style.visibility = "visible";
          opponentSpriteElem.style.opacity = "1";
      ...
      console.error("Error in ensureBattleSpritesVisible:", error);
    }
  ...
  // Call our new sprite fixing function
  ensureBattleSpritesVisible();

  // Add an additional backup call to ensure sprites after a slight delay
  setTimeout(() => {
    ensureBattleSpritesVisible();
  }, 300);

  // Additional debug info for sprites
...
function updateItemButtons() {
  ...
  if (!hasAnyItems) {
    ...
    if (!emptyBagMessage) {
      ...
      emptyBagMessage.textContent =
        "Your bag is empty. Visit the shop to purchase items!";
...
function showMoveTooltip(e) {
  ...
  try {
    ...
    if (availableRightSpace >= 250) {
      // Using 250px as a guideline for tooltip width
...
function useMove(move) {
  ...
  addToBattleLog(
    `${activePlayerCharacter.name} used ${displayMoveName}!`,
    "attack",
    {},
  ...
  if (!isZeroDamageMove && !isHealingMove && !isStatModifyingMove) {
    ...
    if (Math.random() * 100 > effectiveAccuracy) {
      ...
      addToBattleLog(
        `${activePlayerCharacter.name}'s attack missed!`,
        "attack",
        { effectiveness: "miss" },
        activePlayerCharacter,
      );
  ...
  const isAttackAnimation =
    !isZeroDamageMove && !isHealingMove && !isStatModifyingMove;
  ...
  const attackAnimation = isAttackAnimation
  ...
  setTimeout(() => {
    ...
    console.log(
      `Opponent HP: ${currentHP} → ${activeOpponent.hp} (Damage: ${damage})`,
    );
    updateBattleUI();

    // Show damage in battle log with reaction
    const effectivenessValue = calculateTypeEffectiveness(
      move.type,
      activeOpponent.type,
    );
    const damageContext = {
      damage: damage,
      effectiveness:
        effectivenessValue > 1.2
          ? "critical"
          : effectivenessValue < 0.8
            ? "weak"
            : "normal",
    };
...
function executeOpponentMove(move) {
  ...
  addToBattleLog(
    `${activeOpponent.name} used ${displayMoveName}!`,
    "attack",
    {},
    activeOpponent,
  );
  ...
  if (!isZeroDamageMove && !isHealingMove && !isStatModifyingMove) {
    ...
    if (Math.random() * 100 > effectiveAccuracy) {
      // Miss - don't show any attack animations
      addToBattleLog(
        `${activeOpponent.name}'s attack missed!`,
        "attack",
        { effectiveness: "miss" },
        activeOpponent,
      );
  ...
  setTimeout(() => {
    ...
    const hasImposterEffect = playerActiveItemEffects.some(
      (effect) => effect.effect === "imposter",
    );
...
function calculateDamage(attacker, defender, move, attackerMods, defenderMods) {
  ...
  if (!attacker || !defender || !move) {
    console.error("Missing critical parameters in calculateDamage:", {
      attacker,
      defender,
      move,
    });
  ...
  let damage = Math.floor(
    (attackerAttack * attackerModAttack * movePower) / 110,
  );
  ...
  try {
    if (defender === activePlayerCharacter && playerTeam) {
      const playerIndex = playerTeam.findIndex(
        (c) => c && c.id === defender.id,
      );
      maxHP =
        playerIndex >= 0 ? playerTeam[playerIndex].hp : defender.hp || 100;
    } else if (
      opponents &&
      opponentIndex >= 0 &&
  ...
  if (Math.random() < attacker.critRate) {
    ...
    addToBattleLog(
      ...
      "critical-hit",
      {},
      attacker === activePlayerCharacter
        ? activeOpponent
        : activePlayerCharacter,
    );
      ...
      case 1: // Rastamon
        if (move.name === "Irie Recharge") {
          ...
          const healAmount = Math.floor(
            activePlayerCharacter.maxHp * healPercent,
          );
          ...
          addToBattleLog(
            `${activePlayerCharacter.name} recovered ${actualHealAmount} HP!`,
          );
    ...
    switch (activeOpponent.id) {
      case 101: // Functional Addict
        if (move.name === "Sober Up Sis") {
          ...
          addToBattleLog(
            `${activeOpponent.name} recovered ${actualHealAmount} HP!`,
          );
          showFloatingLog(`+${actualHealAmount} HP!`);
        } else {
...
function useItem(itemType) {
  ...
  switch (item.effect) {
    ...
    case "imposter":
      ...
      addToBattleLog(
        `${activePlayerCharacter.name} sent out a Crash Dummy imposter!`,
      );
      ...
      addToBattleLog(
        `The Crash Dummy will take the next hit for ${activePlayerCharacter.name}!`,
      );
      break;
...
function switchYN() {
  ...
  const isActiveFainted =
    activePlayerCharacter && activePlayerCharacter.hp <= 0;
  ...
  const hasAvailableCharacters = playerTeam.some(
...
function handleOpponentFaint() {
  ...
  if (currentGameMode === "story" && activeOpponent && activeOpponent.id) {
    ...
    if (!window.defeatedNPCs.includes(activeOpponent.id)) {
      ...
      console.log(
        `Added NPC ID ${activeOpponent.id} to defeated list:`,
        window.defeatedNPCs,
      );
    }
  }
  ...
  if (opponentIndex >= opponents.length - 1) {
    ...
    setTimeout(() => {
      addToBattleLog(
        `${activeOpponent.name} got faded! Next opponent is coming out!`,
      );
...
function showGameOver(playerWon) {
  ...
  const continueButton = document.getElementById("continue-battle");
  const againButton = document.querySelector(
    "#game-over button:not(#continue-battle):not(#return-to-overworld)",
  );
  ...
  if (playerWon) {
    playSuccessSound();
    document.getElementById("game-over-message").textContent =
      `You won! You completed ${fadeCount} fade${fadeCount !== 1 ? "s" : ""}!`;
    document.getElementById("win-lose-gif").src =
      resultGifs.win[Math.floor(Math.random() * resultGifs.win.length)];
  } else {
...
function continueBattle() {
  ...
  if (battleCounter > 0) {
    const remainingBattles = 3 - battleCounter;
    addToBattleLog(
      `${activePlayerCharacter.name} vs ${activeOpponent.name}! (${remainingBattles} more battle${remainingBattles !== 1 ? "s" : ""} to complete the fade)`,
    );
    showFloatingLog(
      `New opponent: ${activeOpponent.name} (${remainingBattles} more to fade)`,
    );
  } else {
...
function addToBattleLog(
  ...
  if (dialogueType && window.BattleDialogue) {
    try {
      ...
      const urbanDialogue = window.BattleDialogue.generateBattleDialogue(
        dialogueType,
        context,
      );

      // Format dialogue with character-specific styling
      const formattedDialogue = window.BattleDialogue.formatDialogue(
        character,
        urbanDialogue,
      );
  ...
  if (battleLogTextElement.textContent.trim() !== "") {
    battleLogTextElement.textContent =
      battleLogTextElement.textContent + "\n\n" + formattedEntry;
  } else {
  ...
  if (logEntries.length > 15) {
    battleLogTextElement.textContent = logEntries
      .slice(logEntries.length - 15)
      .join("\n\n");
  }
