...
function useItem(character, item) {
  ...
  switch (item.effect) {
    ...
    case "statusCure":
      // Reset status effect
      const hadStatus =
        character.statusEffect && character.statusEffect.type !== "normal";
      ...
      return {
        ...
        clearedStatus: hadStatus,
        message: hadStatus
          ? `${character.name} was cured of status effects!`
          : `${character.name} had no status effect to cure.`,
      };
